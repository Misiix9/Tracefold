...
- Add an updater action above the divider preceding Settings in the sidebar. Its English text is “Update to newest version”; Hungarian text is localized. Use a purple treatment matching the app's restrained palette. Show the action only after discovering a newer compatible release.
...
- README is a short user-facing introduction and installation guide, not developer or contributor documentation. Deliver releases for Windows, macOS and Linux.
