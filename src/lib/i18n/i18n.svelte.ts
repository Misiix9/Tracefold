...
const pluginMessages: Readonly<Record<string, string>> = {
  ...
  'Tracefold could not update plugin storage.': 'A Tracefold nem tudta frissíteni a bővítménytárolót.',
  'The plugin runtime could not start or stop safely.': 'A bővítmény futtatókörnyezete nem indítható vagy állítható le biztonságosan.',
  'The plugin is disabled. Enable it before opening it.': 'A bővítmény le van tiltva. Megnyitás előtt engedélyezd.',
  'Tracefold could not open the plugin window.': 'A Tracefold nem tudta megnyitni a bővítményablakot.',
